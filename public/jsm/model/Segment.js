...
class ImageData {
    ...
    constructor(name = 'default', dims = [0, 0, 0],stored = 8, data = null) {
        ...
        this.name = name;
        this.stored = stored
        this.data = data == null ? new Uint16Array(new ArrayBuffer(dims[0] * dims[1] * dims[2] * 2)).fill(0) : data;
        this.backData = new Uint16Array(new ArrayBuffer(dims[0] * dims[1] * dims[2] * 2)).fill(0)
        ...
        this.thumbnail = new Uint8ClampedArray(new ArrayBuffer(this.thumbnailLength))
...
class ImageData8 {
    ...
    constructor(name = 'default', dims = [0, 0, 0], data = null) {
        this.dims = [...dims];
        this.name = name;
        this.data = data == null ? new Uint8Array(new ArrayBuffer(dims[0] * dims[1] * dims[2])).fill(0) : data;
        this.backData = new Uint8Array(new ArrayBuffer(dims[0] * dims[1] * dims[2])).fill(0)
        this.compressionRate = 1
